---
title: "Class 4: Introduction to web scaping with R"
output: 
 html_document:
...
If you access the page [List of current heads of state and government](https://en.wikipedia.org/wiki/List_of_current_heads_of_state_and_government) and right-click, then you can see the html code behind the website. 
